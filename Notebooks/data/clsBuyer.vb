...
#Region "Constants"
	...
	Public Const CmintBuyerId_DataType As clsGlobalEnum.enumDataTypes  = 
	Public Const CmintBuyerName_DataType As clsGlobalEnum.enumDataTypes  = 
	Public Const CmintAddress1_DataType As clsGlobalEnum.enumDataTypes  = 
	Public Const CmintAddress2_DataType As clsGlobalEnum.enumDataTypes  = 
	Public Const CmintAddress3_DataType As clsGlobalEnum.enumDataTypes  = 
	Public Const CmintAddress4_DataType As clsGlobalEnum.enumDataTypes  = 
	Public Const CmintPhone1_DataType As clsGlobalEnum.enumDataTypes  = 
	Public Const CmintPhone2_DataType As clsGlobalEnum.enumDataTypes  = 
	Public Const CmintMobilePhone_DataType As clsGlobalEnum.enumDataTypes  = 
