...
#Region "Variables - Property"
	...
	Private mobjColors As clsColors
...
#Region "Properties"
	...
	Public ReadOnly Property ClassAttribute() As clsClassAttribute
		...
		End Get
	End Property
	Public ReadOnly Property Colors() As clsColors
		Get
			Return mobjColors
		End Get
	End Property
...
#Region "Functions"
	...
	'----/* Functionality  - Start */----
		...
		If mobjColors.Initialize_CO(mobjClassAttribute) = False Then Goto ExitFunction
		If mobjColors.RS.RS_Refresh() = False Then Goto ExitFunction
	...
	'----/* Functionality  - Start */----
		...
		mobjColors = New clsColors(mobjSolutionBO)
