...
#Region "Variables - General"
	...
	Private mobjColor As clsColor
	Private mobjColorsBO As clsColorsBO
...
#Region "Properties"
	...
	Public ReadOnly Property ClassAttribute() As clsClassAttribute
		...
		End Get
	End Property
	Public ReadOnly Property ColorsBO() As clsColorsBO
		Get
			Return mobjColorsBO
		End Get
	End Property
...
#Region "Functions"
	...
	'----/* Functionality  - Start */----
		...
		mobjColor = mobjColorsBO.Colors.Color
		mobjGUI = InoutobjGUI
		...
		mobjColorsBO.Colors.RS.RS_SelectWhere = mobjFormAttribute.WhereClause_A
		If mobjColorsBO.Initialize_BO(mobjClassAttribute) = False Then Goto ExitFunction
	...
	'----/* Functionality  - Start */----
		...
		Else
				strFieldName = mobjColor.FieldName(clsColor.enumFieldsColor.eColorUid)
		If mobjColorsBO.Colors.RS.RS_Find(strFieldName, Trim(InstrSearchValue)) Then
			If IsNothing(mobjFunction_RecordsetReposition_GUI) = False Then If mobjFunction_RecordsetReposition_GUI() = False Then Goto ExitFunction
	...
	'----/* Functionality  - Start */----
		If mobjColorsBO.Colors.RS.RS_Find(InstrFieldName, InstrSearchValue) = False Then Goto ExitFunction
	...
	'----/* Functionality  - Start */----
		If mobjColorsBO.Colors.RS.RS_Refresh() = False Then Goto ExitFunction
		If IsNothing(mobjFunction_RecordsetReposition_GUI) = False Then If mobjFunction_RecordsetReposition_GUI() = False Then Goto ExitFunction
	...
	'----/* Functionality  - Start */----
			...
			If(mobjColorsBO.Colors.RS.RS_Bof And mobjColorsBO.Colors.RS.RS_Eof) Then
			...
			End If
			If mobjSolutionBO.AppBO.GF_Desktop.DisplayRecordPosition(mobjColorsBO.Colors.RS.RS_AbsolutePosition, mobjColorsBO.Colors.RS.RS_RecordCount, mobjlblRecordStatus.Text) = False Then Goto ExitFunction
	...
	'----/* Functionality  - Start */----
		...
		mobjColorsBO = New clsColorsBO(mobjSolutionBO)
...
#Region "Event Functions"
	...
	'----/* Functionality  - Start */----
		...
		If mobjColorsBO.CRUDS.Add() = False Then Goto ExitFunction
	...
	'----/* Functionality  - Start */----
		If mobjColorsBO.CRUDS.Cancel() = False Then Goto ExitFunction
		If IsNothing(mobjFunction_RecordsetReposition_GUI) = False Then If mobjFunction_RecordsetReposition_GUI() = False Then Goto ExitFunction
	...
	'----/* Functionality  - Start */----
		...
		If intMsgResult = vbYes
			If mobjColorsBO.CRUDS.Delete()= False Then Goto ExitFunction
		If IsNothing(mobjFunction_RecordsetReposition_GUI) = False Then If mobjFunction_RecordsetReposition_GUI() = False Then Goto ExitFunction
		End If
	...
	'----/* Functionality  - Start */----
		If mobjColorsBO.CRUDS.Edit() = False Then Goto ExitFunction
	...
	'----/* Functionality  - Start */----
		...
		If intMsgResult = vbYes Then 
			...
			If mobjColorsBO.CRUDS.Save() = False Then Goto ExitFunction
		If IsNothing(mobjFunction_RecordsetReposition_GUI) = False Then If mobjFunction_RecordsetReposition_GUI() = False Then Goto ExitFunction
		End If
	...
	'----/* Functionality  - Start */----
		...
		If InstrRecordSource = clsGlobalEnum.CgstrBlank Then
			If mobjApp.AppUI.AppUI_Functions.AFUI_cmdGoToId_Click(mobjColorsBO.Colors.RS.RS_RecordSource, clsColor.enumFieldsColor.eColorUid, mobjGUI, mobjtxtGoToId) = False Then Goto ExitFunction
		Else
			If mobjApp.AppUI.AppUI_Functions.AFUI_cmdGoToId_Click(InstrRecordSource, clsColor.enumFieldsColor.eColorUid, mobjGUI, mobjtxtGoToId) = False Then Goto ExitFunction
		End If
	...
	'----/* Functionality  - Start */----
		mobjColorsBO.Colors.RS.RS_MoveFirst()
		If IsNothing(mobjFunction_RecordsetReposition_GUI) = False Then If mobjFunction_RecordsetReposition_GUI() = False Then Goto ExitFunction
	...
	'----/* Functionality  - Start */----
		mobjColorsBO.Colors.RS.RS_MoveLast()
		If IsNothing(mobjFunction_RecordsetReposition_GUI) = False Then If mobjFunction_RecordsetReposition_GUI() = False Then Goto ExitFunction
	...
	'----/* Functionality  - Start */----
		mobjColorsBO.Colors.RS.RS_MoveNext()
		If IsNothing(mobjFunction_RecordsetReposition_GUI) = False Then If mobjFunction_RecordsetReposition_GUI() = False Then Goto ExitFunction
	...
	'----/* Functionality  - Start */----
		mobjColorsBO.Colors.RS.RS_MovePrevious()
		If IsNothing(mobjFunction_RecordsetReposition_GUI) = False Then If mobjFunction_RecordsetReposition_GUI() = False Then Goto ExitFunction
	...
	'----/* Functionality  - Start */----
		If InstrRecordSource = clsGlobalEnum.CgstrBlank Then
		If mobjApp.AppUI.AppUI_Functions.AFUI_chkGrid_CheckStateChanged(mobjColorsBO.Colors.RS.RS_RecordSource, clsColor.enumFieldsColor.eColorUid, mobjGUI, mobjchkGrid, mobjColorsBO.Colors) = False Then Goto ExitFunction
		Else
		If mobjApp.AppUI.AppUI_Functions.AFUI_chkGrid_CheckStateChanged(InstrRecordSource, clsColor.enumFieldsColor.eColorUid, mobjGUI, mobjchkGrid, mobjColorsBO.Colors) = False Then Goto ExitFunction
		End If
