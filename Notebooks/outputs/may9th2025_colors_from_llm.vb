...
#Region "Constants"
	...
	Public Const CmintColorUid_Length As Integer = 4
	Public Const CmintColorcode_Length As Integer = 10
	Public Const CmintColorname_Length As Integer = 30
	...
	Public Const CmintColorcode_DataType As clsGlobalEnum.enumDataTypes = clsGlobalEnum.enumDataTypes.eInteger
...
#Region "Variables - Property"
	...
	Private mlngColorcode As Integer
	...
	Public Property FieldValue(ByVal InintIndex As Integer) As String Implements ifaBusinessElement.FieldValue
		Get
			...
			Select Case InintIndex
				...
				Case enumFieldsColor.eColorcode
					strReturnValue = Colorcode.ToString()
				Case enumFieldsColor.eColorname
		...
		Set(ByVal Value As String)
			Select Case InintIndex
				...
				Case enumFieldsColor.eColorcode
					Colorcode = Convert.ToInt32(Value)
				Case enumFieldsColor.eColorname
					Colorname = Value
			End Select
		End Set
